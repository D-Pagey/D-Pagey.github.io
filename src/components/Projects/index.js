...
function Projects() {
    return (
        <section className='project-container' id='projects'>
            ...
            <a 
            href='https://github.com/d-pagey/calculator' target='_blank' 
            ...
            <a href='https://github.com/d-pagey/pomodoro' target='_blank' 
            rel='noopener noreferrer'><img className='thumbnail' src={pomodoro} 
            alt='Pomodoro Thumbnail' /></a>

            <a href='https://github.com/d-pagey/quoter' target='_blank' 
            rel='noopener noreferrer'><img className='thumbnail' src={quoter} 
            alt='Quoter Thumbnail' /></a>
        </section>
    )
}
